...
const Canvas = forwardRef(({ template, text, paletteIndex, lotteryNumbers }, ref) => {
  ...
  useEffect(() => {
    ...
    offCtx.save();
    template.render(offCtx, text, palette, lotteryNumbers);
    offCtx.restore();
  ...
  }, [template, text, paletteIndex, lotteryNumbers]);
