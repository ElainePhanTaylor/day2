...
const Canvas = forwardRef(({ template, text, paletteIndex, lotteryNumbers, astroData }, ref) => {
  ...
  useEffect(() => {
    ...
    offCtx.save();
    template.render(offCtx, text, palette, lotteryNumbers, astroData);
    offCtx.restore();
  ...
  }, [template, text, paletteIndex, lotteryNumbers, astroData]);
